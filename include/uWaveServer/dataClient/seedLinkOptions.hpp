#ifndef UWAVE_SERVER_DATA_CLIENT_SEED_LINK_OPTIONS_HPP
#define UWAVE_SERVER_DATA_CLIENT_SEED_LINK_OPTIONS_HPP
#include <chrono>
#include <vector>
#include <memory>
...
public:
    ...
    /// @}
private:
    class SEEDLinkOptionsImpl;
    std::unique_ptr<SEEDLinkOptionsImpl> pImpl;
};
}
#endif
