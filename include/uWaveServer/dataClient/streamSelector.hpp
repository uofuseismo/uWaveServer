#ifndef UWAVE_SERVER_DATA_CLIENT_STREAM_SELECTOR_HPP
#define UWAVE_SERVER_DATA_CLIENT_STREAM_SELECTOR_HPP
#include <chrono>
#include <memory>
namespace UWaveServer::DataClient
{
/// @class StreamSelector "streamSelector.hpp" "uWaveServer/dataClient/streamSelector.hpp"
